...
/**
 * CribAltComputerPlayer -
 * This is an alternative 'smart' computer player.
 *
 * @author
 * @version March 2023
 */
public class CribAltComputerPlayer extends GameComputerPlayer {
     ...
     */
    public CribAltComputerPlayer(String name) {super(name);}
